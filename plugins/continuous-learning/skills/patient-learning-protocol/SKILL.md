...
description: Learning framework for gradual skill acquisition through patient observation
triggers:
  - "learn gradually through observation"
  - "acquire new skill patiently"
