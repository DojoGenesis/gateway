// Package workflowui embeds the compiled Workflow Builder SPA.
//
// The dist/ directory is populated by running `make build-spa` (or
// `npm run build` in workflow-builder/ then copying to this directory).
// The embedded filesystem is served by the Gateway at GET /workflow/*.
//
